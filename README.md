...
| `pieces.h` | Two selectable piece bitmap sets (MENU's PIECE SET option) -- Classic, converted from the "SmallPng" set in [samboy/ChessGraphics](https://github.com/samboy/ChessGraphics) (public domain), and Pixel, cropped from the classic/Staunton-style set in Brianna Cason's ("hanahoa") ["Chess and Checkers"](https://hanahoa.itch.io/chess-and-checkers) itch.io asset (CC BY 4.0) -- just the bitmap tables, no drawing logic. |
